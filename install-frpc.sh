...
program_version_link="https://raw.githubusercontent.com/clangcn/onekey-install-shell/master/frpc/version.sh"
str_install_shell=https://raw.githubusercontent.com/clangcn/onekey-install-shell/master/frpc/install-frpc.sh
shell_update(){
    fun_clangcn "clear"
...
fun_clangcn(){
    ...
    echo "+---------------------------------------------------------+"
    echo "|          Intro: http://www.angshuo.cn/                  |"
    echo "+---------------------------------------------------------+"
    echo ""
}
fun_set_text_color(){
...
fun_download_file(){
    ...
    if [ ! -s ${str_program_dir}/${program_name} ]; then
        ...
        mv frp_${FRPS_VER}_linux_${ARCHS}/frpc ${str_program_dir}/${program_name}
        rm -fr ${program_latest_filename} frp_${FRPS_VER}_linux_${ARCHS}
    fi
...
# if you want to configure or reload frpc by dashboard, dashboard_port must be set
